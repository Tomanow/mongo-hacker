 ...
 *
 * Forked and fixed up by Tomanow
 * https://github.com/Tomanow/mongo-hacker
 *
 */

mongo_hacker_config = {
  verbose_shell:    true,             // additional verbosity
  index_paranoia:   false,            // query time explain
  enhance_api:      true,             // additional api extensions
  ...
  windows_warning:  false,            // show warning banner regarding color support for Windows
  ...
  dbref:            {
    extended_info: true,              // enable more information on DBRef
...
// Always set rs.secondaryOk() for secondaries
